...
# ------------------------------------------------
def getOptimizer(optimizer=None):
    '''
        combine optimizer with related setting
    '''
    OptimizerSpec = namedtuple("OptimizerSpec", ["constructor", "kwargs"])
    if optimizer is None:
        optimizer = optim.RMSprop
        
    wrapped_optimizer = OptimizerSpec(
...
def init_model(env, 
               model : DQN):
    '''
        using the env information to init DQN model
    '''
    channel = ARGS.framelen * 1
